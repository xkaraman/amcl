...
//
//  pcl::registration::TransformationEstimation<pcl::PointXYZRGBA, pcl::PointXYZRGBA>::Ptr transformation_estimation (new pcl::registration::TransformationEstimationSVD<pcl::PointXYZRGBA, pcl::PointXYZRGBA>);
//  transformation_estimation->estimateRigidTransformation(*source_segmented_, *target_segmented_,initial_transformation_matrix_);
...
//  registration->setRANSACOutlierRejectionThreshold (0.15);
...
////  cout << "OK" << endl;
////  cout << "Segmented Cloud" << *source_segmented_<< endl;
////  cout << "Transformed Cloud" << *source_transformed_<< endl;
////  cout << "Registered Cloud" << *source_registered_<< endl;
//}
//
//template<typename FeatureType>
